...
const eslintConfig = [
...

  {
    ...
    rules: {
       ...
       * Temporarily disabled - complex selector for JSX attributes not working properly
       * TODO: Re-enable with proper selector for conditional styling exceptions
       */
      // 'no-restricted-syntax': [
      //   'error',
      //   {
      //     selector: 'ConditionalExpression:not([parent.type="JSXAttribute"]):not([parent.type="CallExpression"][parent.callee.name="cn"])',
