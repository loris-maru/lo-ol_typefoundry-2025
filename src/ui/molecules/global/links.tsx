...
export function SmallLink({ link, label }: Link) {
  return (
    <Link
      className="font-whisper relative mt-2 px-8 py-2 border border-solid border-white rounded-full text-base transition-colors duration-300 ease-in-out hover:bg-black hover:text-white"
      href={link}
    >
